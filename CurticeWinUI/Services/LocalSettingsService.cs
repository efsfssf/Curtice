...
using CurticeWinUI.Core.Contracts.Services;
using CurticeWinUI.Core.Helpers;
...
{
    private const string _defaultApplicationDataFolder = "CurticeWinUI/ApplicationData";
